          ...
          <tbody>
            ...
            <?php foreach ($data_kategori as $kat) : ?>
              <tr>
                ...
                <td><?= $kat['nama'] ?></td>
                <td>
                  <a href="<?= base_url('kategori/edit-kategori/' . $kat['id_kategori']) ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
...
<script>
  $(document).ready(function() {
    ...
    $('.deleteButton').on("click", function() {
      $('#formDelete').attr("action", "<?= base_url('kategori/hapus-kategori') ?>/" + $(this).data('id'));
    })
  });
</script>
<?= $this->endSection() ?>